(defproject pprint-warning "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "pprint-warning.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main pprint-warning.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "pprint-warning.core/on-figwheel-reload"}

                :compiler {:main pprint-warning.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/pprint_warning.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main pprint-warning.test-runner
                           :optimizations :none}}
